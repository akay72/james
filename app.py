...
with info_expander:
    st.markdown(
        ...
        <div class="instructions-container">
            ...
            <ul>
                <li><strong>Enter</strong> the search terms related to the business you are looking for in the 'Enter search terms' field.</li>
                <li><strong>Specify</strong> the location in which you want to search for businesses in the 'Enter location' field.</li>
                <li><strong>Click</strong> the 'Scrape Data' button to start the scraping process.</li>
                <li><strong>View</strong> the data displayed on the main page after scraping.</li>
                <li><strong>Download</strong> the scraped data as a CSV file by clicking the 'Download data as CSV' button.</li>
                <li><strong>Check</strong> the latest data from your most recent search displayed on the main page.</li>
            </ul>
            <p>This app scrapes business data from Yellow Pages, including titles, phone numbers, addresses, and more based on the provided search criteria.</p>
        </div>
        """,
        unsafe_allow_html=True
    )
...
def scrape_yellow_pages(search_terms, location):
    ...
    # Return a list of tuples with the scraped data
